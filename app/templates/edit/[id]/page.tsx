  ...
  useEffect(() => {
    const fetchTemplate = async () => {
      try {
        ...
        const response = await fetch(`/api/plantillas/${templateId}`)
        ...
        if (data.plantilla) {
          setName(data.plantilla.nombre)
          setContent(data.plantilla.contenido)
          setDescription(data.plantilla.descripcion || "")
        }
      } catch (error) {
  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
        <div>
          <h2 className="text-2xl font-bold tracking-tight">Editar Plantilla</h2>
          <p className="text-muted-foreground">Actualiza los detalles de la plantilla</p>
        </div>
        <Link href="/templates">
        ...
        <div className="md:col-span-2 space-y-6">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Actualiza los detalles de tu plantilla</CardDescription>
            </CardHeader>
            <CardContent>
